/*------------------------------------------------------------
	Identify Simple Shapes (rectagle, circle, squigly, triangle, line)
	- recognize (and other supporting functions)
------------------------------------------------------------*/
...
function recognize(figure) {
    ...
    else if (inRange(areaRatio, 0.7, 0.83)) {
    	identified = "circle";
    }
